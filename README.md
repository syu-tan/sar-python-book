...
## サポートページ
「SAR衛星データ解析入門」の[サポートページ](./doc/support.md)です。
正誤表や問題点についてはこちらで記載、対応していく予定です。

## 付録

付録の章である**フーリエ変換と相関処理**については、[Github(このレポジトリ)](./book/appendix.pdf)にて、無料配布しております。
...
| ------------------------- | ---------------------- | ------------------------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 第1章 SARの基礎と観測原理 |                        |                                |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
|                           | 合成開口               | 合成開口の基本                 | <ul><li> [1\_1\_3\_impulse\_response.ipynb](./src/1_1_3_impulse_response.ipynb)</li><br><li>[1\_1\_5\_migration.ipynb](./src/1_1_5_migration.ipynb)</li><br><li>[1\_1\_6\_999\_synthetic\_aperture.ipynb](./src/1_1_6_999_synthetic_aperture.ipynb)</li><br><li>[1\_1\_6\_focus.ipynb](./src/1_1_6_focus.ipynb)</li></ul>                                                                                                                                                                                                                                                                                       |
|                           | SARの性能              | ビーム・軌道                   | <ul><li>[1\_3\_2\_antena\_pattarn.ipynb](./src/1_3_2_antena_pattarn.ipynb)</li><br><li>[1\_3\_2\_beam.ipynb](./src/1_3_2_beam.ipynb)</li><br><li>[1\_3\_2\_orbit.ipynb](./src/1_3_2_orbit.ipynb)</li></ul>                                                                                                                                                                                                                                                                                                                                                                                                      |
|                           | レーダー特有の現象     | 偏波・アンビギュイティ、RFI    | <ul><li>[1\_4\_1\_polarimetry.ipynb](./src/1_4_1_polarimetry.ipynb)</li><br><li>[1\_4\_3\_multilooking.ipynb](./src/1_4_3_multilooking.ipynb)</li><br><li>[1\_4\_7\_ambiguity.ipynb](./src/1_4_7_ambiguity.ipynb)</li><br><li>[1\_4\_7\_ambiguity\_azimuth.ipynb](./src/1_4_7_ambiguity_azimuth.ipynb)</li><br><li>[1\_4\_7\_ambiguity\_range.ipynb](./src/1_4_7_ambiguity_range.ipynb)</li><br><li>[1\_4\_9\_radio\_frequency\_interference.ipynb](./src/1_4_9_radio_frequency_interference.ipynb)</li></ul>                                                                                                   |
...
| 第2章 SARデータの解析準備 |                        |                                |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |    |
|                           | 地理空間データの処理   | ジオリファレンス               | <ul><li>[2\_2\_sar\_georeference.ipynb](./src/2_2_sar_georeference.ipynb)</li></ul>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
| 第3章 SARデータの解析     |                        |                                |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
...
貴重なデータの使用を快諾いただきました【*ESA*, *ICEYE*, *JAXA*, *Synspective*】の皆様に深く感謝申し上げます。また、【*Capella Space*, *CSA*, *Hisdesat*, *NASA*, *Umbra Lab*, *国土地理院*】が提供するオープンデータを利用させていただきました。利用しやすいライセンスのデータを公開する取り組みに深く感謝申し上げます。
